                    ...
                    <div class="box-container">
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="box-with-icon-left">
                                ...
                                <div class="text">
                                    <h2>Ocean Freight</h2>
                                    <p>United Nations Diplomatic Courier has a wide selection of Ocean freight products. We ensure your cargo reaches the right destination, at the right time and at a cost effective way. Our alliances with ocean carriers handle every major container port in the world. Our volumes managed within our network provide expertise and competitive rate structures.<br><br>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="box-with-icon-left">
                                ...
                                <div class="text">
                                    <h2>Air Freight</h2>
                                    <p>Air Freight is a part of the comprehensive and efficient network that has been developed to ensure that your products will deliver on time and with zero error. RAK Logistics partners with airlines and freight forwarders to offer seamless air freight solutions to clients globally.<br><br>
                                        We offer a competitive and quick service which includes our air express, high priority (24 hours) delivery, and value services. As a leading provider of air cargo services, we offer our clients an unmatched repertoire of experiences and skills in cargo freight management, and air operations.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="box-with-icon-left">
                                ...
                                <div class="text">
                                    <h2>Warehousing</h2>
                                    <p>Partnering with a third party logistics (3PL) company to manage your supply chain, gives you flexibility to focus on other areas of your business. <br><br>
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="box-with-icon-left">
                                ...
                                <div class="text">
                                    <h2>Re-packaging</h2>
                                    <p>United Nations Diplomatic Courier Delivery Services has a different and unique way of repackaging parcels to meet international standard. We also package again or anew specifically : to put into a more efficient or attractive form.</p>
                                </div>
                            </div>
                        </div>
